...
export const IconReset: React.FC<React.SVGProps<SVGSVGElement>> = (props) => <RetroIcon {...props}><rect x="2" y="2" width="20" height="2"/><rect x="2" y="2" width="2" height="8"/><rect x="2" y="8" width="8" height="2"/><polygon points="8,6 12,8 8,10"/></RetroIcon>;
export const IconSkipBack: React.FC<React.SVGProps<SVGSVGElement>> = (props) => <RetroIcon {...props}><rect x="6" y="6" width="2" height="12"/><polygon points="8,6 16,12 8,18"/></RetroIcon>;
